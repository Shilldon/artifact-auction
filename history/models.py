...
class Historical_Figure(models.Model):
    artifact_possessed = models.ForeignKey(Artifact,
    ...
    def clean(self):
        try:
            ...
            """
            raise ValidationError("Please enter the artifact associated with "
                                  "this person.")
...
class Event(models.Model):
    ...
    def clean(self):
        ...
        if month is None and day:
            raise ValidationError("Enter day of the month.")
        """
        Raise errors if day is outside the number of days in a particular month
        """
        if month in [4, 6, 9, 11] and day > 30:
            raise ValidationError("Day must be less than 31.")
